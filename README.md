...
```bash
$ go get github.com/nbarbey/limiter
```
...
* Create a `limiter.Store` instance _(see [Redis](https://github.com/nbarbey/limiter/blob/master/drivers/store/redis/store.go) or [In-Memory](https://github.com/nbarbey/limiter/blob/master/drivers/store/memory/store.go))_
...
import "github.com/nbarbey/limiter"
...
// race condition.
import "github.com/nbarbey/limiter/drivers/store/redis"
...
import "github.com/nbarbey/limiter/drivers/store/memory"
...
* [HTTP](https://github.com/nbarbey/limiter/tree/master/examples/http/main.go)
* [Gin](https://github.com/nbarbey/limiter/tree/master/examples/gin/main.go)
...
* Fork the [project](https://github.com/nbarbey/limiter)
* Fix [bugs](https://github.com/nbarbey/limiter/issues)
...
[godoc-url]: https://godoc.org/github.com/nbarbey/limiter
[godoc-img]: https://godoc.org/github.com/nbarbey/limiter?status.svg
[license-img]: https://img.shields.io/badge/license-MIT-blue.svg
[travis-url]: https://travis-ci.org/ulule/limiter
[travis-img]: https://travis-ci.org/ulule/limiter.svg?branch=master
[goreport-url]: https://goreportcard.com/report/github.com/nbarbey/limiter
[goreport-img]: https://goreportcard.com/badge/github.com/nbarbey/limiter
